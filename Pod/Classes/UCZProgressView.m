...
- (void)setBackgroundView:(UIView *)backgroundView {
    ...
    if ([backgroundView isKindOfClass:[UIVisualEffectView class]]) {
        UIVisualEffectView* visualEffectView = (UIVisualEffectView*) backgroundView;
        [visualEffectView.contentView addSubview:self.textLabel];
    }else {
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated {
    ...
    self.progressLayer.actions = animated ? nil : @{@"p": [NSNull null]};
